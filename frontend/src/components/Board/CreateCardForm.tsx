...
export function CreateCardForm({columnId}:CreateCardFormProps){
    ...
    const handleSubmit = async (e?:React.FormEvent) => {
        ...
        await dispatch(createCardThunk({
            title,
            description,
            column:columnId,
            boardId:publicId
        ...
        if(isEditing){
            return (
                <form onSubmit={handleSubmit} style={{marginTop: 10 ,display: "flex", flexDirection: "column", gap: "8px"}}>
                <input
